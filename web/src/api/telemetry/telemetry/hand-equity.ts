...
static createHandEquity(builder:flatbuffers.Builder, handNameOffset:flatbuffers.Offset, equity:number, wins:number, ties:number, losses:number, simulations:number, winMethodMatrixOffset:flatbuffers.Offset):flatbuffers.Offset {
